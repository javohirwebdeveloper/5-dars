...
const Career = () => {
  ...
  <link rel="stylesheet" href="/assets/index.72dbb0e3.css" />
  <link
    rel="stylesheet"
  ...
  <link
    ...
    as="script"
    crossOrigin=""
    href="/assets/PIndex.14e4e361.js"
  />
  <link rel="stylesheet" href="/assets/PIndex.ac2e390a.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/PortfolioTitle.d53edc35.js"
  />
  <link rel="stylesheet" href="/assets/PortfolioTitle.c9874b09.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/WhiteButton.da94156e.js"
  />
  <link rel="stylesheet" href="/assets/WhiteButton.d8aed8b5.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/ClientsComment.75c68213.js"
  />
  <link rel="stylesheet" href="/assets/ClientsComment.43a4bcdc.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/swiper.min.4bcce7ec.js"
  />
  <link rel="stylesheet" href="/assets/swiper.min.c4a73ca1.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/navigation.a0dd03d0.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/pagination.e7adf9b1.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/useOnLanguageChange.029edf3e.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/portfolio.10467127.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/global.170671ce.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/PVacancy.6695dd28.js"
  />
  <link rel="stylesheet" href="/assets/PVacancy.06d27473.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/BigTitle.852a632a.js"
  />
  <link rel="stylesheet" href="/assets/BigTitle.7176b47c.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/vacancy.bf59dabf.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/PCSVacancy.9e37c235.js"
  />
  <link rel="stylesheet" href="/assets/PCSVacancy.e88e9213.css" />
  <link rel="stylesheet" href="/assets/pagination.min.7403cca2.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/GalleryCardSlider.976ee11f.js"
  />
  <link rel="stylesheet" href="/assets/GalleryCardSlider.174ec93a.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/BasicInput.588b6201.js"
  />
  <link rel="stylesheet" href="/assets/BasicInput.317b72db.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/BasicSelect.392261f2.js"
  />
  <link rel="stylesheet" href="/assets/BasicSelect.6a6df70e.css" />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/gallery.5013f06c.js"
  />
  <link
    rel="modulepreload"
    as="script"
    crossOrigin=""
    href="/assets/index.41e2f270.js"
  />
  <title />
       ...
       <Navbar/>
        <main data-v-1cc107bd="" className="">
          <div data-v-1cc107bd="" className="min-h-[100vh]">
            <div data-v-16bfd3a6="">
              <div data-v-16bfd3a6="" className="container">
                <div
                  data-v-16bfd3a6=""
                  className="pt-[120px] pb-[80px] aos-init aos-animate"
                  data-aos="fade-left"
                  data-aos-duration={500}
                >
                  <div data-v-2082a543="" data-v-16bfd3a6="" className="">
                    <div
                      data-v-2082a543=""
                ...
                <h2 data-v-16bfd3a6="" className="invisible">
                  {" "}
                  In UIC Group there are some vacancies which is maybe for your.
                  Try it out!{" "}
                </h2>
                <div
                  data-v-16bfd3a6=""
                  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-[49px]"
                >
                  <a
                    data-v-c9fd75cc=""
                    href="/vacancy/19"
                    className="relative px-3 py-3 text-white cursor-pointer vacancy-card group bg-vacancy-card-background md:py-6 md:px-7 rounded-8 aos-init aos-animate"
                  ...
                  >
                    ...
                    <hr
                      data-v-c9fd75cc=""
                      className="my-4 border-vacancy-card-divider"
                    />
                    <div
                      data-v-c9fd75cc=""
                      className="flex flex-col justify-between gap-2 sm:flex-row"
                    >
                      <div data-v-c9fd75cc="" className="flex items-center">
                        <div data-v-c9fd75cc="" className="icon-bg">
                          <i
                            data-v-56c03d90=""
                            data-v-c9fd75cc=""
                        ...
                        <span
                          data-v-c9fd75cc=""
                          className="font-medium text-[13px] text-vacancy-card-icon-text uppercase group-hover:text-white transition-colors"
                        >
                          Monday - Friday
                        </span>
                      </div>
                      <div data-v-c9fd75cc="" className="flex items-center">
                        ...
                        <span
                          data-v-c9fd75cc=""
                          className="font-medium text-[13px] text-vacancy-card-icon-text group-hover:text-white transition-colors"
                        >
                          09:00 - 18:00
                        </span>
                      </div>
                    </div>
                    <div data-v-c9fd75cc="" className="h-5" />
                    <div
                      data-v-c9fd75cc=""
                    ...
                    >
                      ...
                      >
                        <div
                          data-v-c9fd75cc=""
                          className="flex-1 py-0.5 px-2 flex items-center gap-2 vacancy-card-button"
                        >
                          <i
                            data-v-56c03d90=""
                            data-v-c9fd75cc=""
                            className="icon hover:text-red-500 text-[#00A795] group-hover:text-white transition-colors"
                          >
                            <svg
                              width={22}
                              height={22}
                          ...
                          <span
                            data-v-c9fd75cc=""
                            className="font-bold text-white text-[14px] md:text-[18px]"
                          >
                        ...
                        <button
                          data-v-c9fd75cc=""
                          className="bg-[#00A795] group-hover:bg-[#FFFFFF47] transition-colors h-[24px] w-[24px] rounded-full flex items-center justify-center"
                          aria-label="button"
                        >
                          <i
                            data-v-56c03d90=""
                ...
                <div
                  data-v-16bfd3a6=""
                  className="pt-[61px] pb-16 flex justify-center items-center aos-init aos-animate"
                  data-aos="fade-up"
                >
                  <button
                    data-v-16bfd3a6=""
                    className="bxsr relative pt-[13px] pb-3.5 px-6 font-bold text-base text-white border border-solid border-[#ffffff33] rounded-xl duration-300 hover:border-[#00A795] hover:text-[#00A795] flex items-center justify-center"
                    aria-label="button"
                  >
                    <div
                      data-v-16bfd3a6=""
                      className="absolute inset-0 w-full h-full flex items-center justify-center opacity-0 transition-all duration-200"
                    >
                      <span data-v-16bfd3a6="" className="spinnerr" />
                    </div>{" "}
                    Load More
                  </button>
                </div>
              ...
              <div
                data-v-16bfd3a6=""
                className="clients-comment bg-[#141415] pt-11 pb-[45px] md:py-16"
                about="about"
              >
                <div className="container relative">
                  <div
                    className="text-center section-title_green mb-9 md:mb-11 aos-init"
                    data-aos="fade-up"
                    data-aos-duration={500}
                  >
                    Client Opinion
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            data-v-643a1fb5=""
                            className="flex items-start justify-center order-last col-span-12 gap-5 pb-3 mb-6 md:col-span-6 md:justify-start md:order-first md:mt-0 mt-14 md:mb-0 md:pb-0 aos-init"
                            data-aos="fade-up"
                            data-aos-duration={500}
                          >
                            <img
                          ...
                          <div
                            data-v-643a1fb5=""
                            className="order-first col-span-12 md:col-span-6 md:row-span-2 row-span-full blockquote-icon-wrapper aos-init"
                            data-aos="fade-up"
                          ...
                          <div
                            data-v-643a1fb5=""
                            className="col-span-12 row-span-3 md:col-span-6 aos-init"
                            data-aos="fade-up"
                          ...
                          >
                            ...
                            >
                              <p>
                                ...
                                civil servants. The main purpose of this portal
                                is to ensure selection of qualified personnel.
                                We express our gratitude to the team of "UIC
                                Group" for the modern design of this unified
                                system.
                              </p>
                            </div>
                          </div>
                              ...
                              <p>
                                <span style={{ fontSize: "11pt" }}>
                                  ...
                                  >
                                    ...
                                    yanada osonlashtirdi. TDIU jamoasi
                                    &nbsp;“UIC Group” IT kompaniyasining
                                    malakali mutaxassislariga o'z
                            ...
                            >
                              ...
                              >
                                <p>
                                  ...
                                  bolishidan qat'iy nazar talab va istaklaridan
                                  kelib chiqqan holda eng optimal yechimni bera
                                  oladigan kuchli jamoadir.
                                </p>
                              </div>
                            </div>
                            <div
...
s                    <div className="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
