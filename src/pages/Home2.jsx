    ...
    <div className="">
      ...
      <Navbar/>
        <div className="min-h-[100vh]">
          <section data-v-e607458a="" className="overflow-hidden">
            <div
            ...
            >
              ...
              >
                <div
                  data-v-385d9ae6=""
                  className="container main-block__container absolute z-10 lg:pt-[316px] md:pt-[250px] sm:pt-[172px] pt-[172px]"
                >
                  <div
                    data-v-385d9ae6=""
                    className="hero-info md:max-w-[506px] w-full"
                  >
                    <h2
                      data-v-385d9ae6=""
                    ...
                    >
                      ...
                      <a
                        data-v-ef362752=""
                        data-v-385d9ae6=""
                        className="!pl-[25px] !backdrop-blur-none !border-white flex py-[3px] md:py-0 w-fit px-[14px] sm:px-4 items-center borders justify-center border border-solid rounded-12 transition duration-500 ease-in-out cursor-pointer hover:!bg-green hover:!border-green"
                        download=""
                  ...
                  <div
                    data-v-385d9ae6=""
                    className="w-[94px] h-[94px] scale-125 hover:scale-150 opacity-90 relative xl:mt-[173px] md:mt-[100px] sm:mt-[288px] mt-[268px] flex justify-center mx-auto showreel-wrapper cursor-pointer text-[#fff] transition-all duration-300"
                  >
                    <i
                      data-v-56c03d90=""
                      data-v-385d9ae6=""
                ...
                <div data-v-385d9ae6="" className="main-block__background">
                  <span
                    data-v-385d9ae6=""
                    className="uic"
                    id="uic"
                  ...
                  >
                    <div data-v-385d9ae6="" className="container">
                      <i
                        data-v-56c03d90=""
                        data-v-385d9ae6=""
                        className="icon hover:text-red-500 uic_new"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span data-v-385d9ae6="" id="main-bg" className="bg">
                    <img
                      data-v-385d9ae6=""
            ...
            <div
              data-v-77920e16=""
              data-v-e607458a=""
              className="container sectionInfo pb-[60px] md:!px-[124px] md:!pb-[91px] gap-x-[121px] flex justify-center sm:flex-col xl:flex-row lg:flex-col lg:pt-[180px] md:pt-[110px] sm:pt-[60px] pt-[60px]"
            >
              <div
                data-v-77920e16=""
                className="hidden md:!flex justify-center gap-x-6 lg:pb-12 md:pb-12 relative"
              >
                <div
                  data-v-77920e16=""
                  className="absolute right-[-60px] top-[-60px] z-10 translate-y-[-50%] translate-x-[50%] rotate-anim"
                >
                  <span data-v-77920e16="">
                    <i
                      data-v-56c03d90=""
                      data-v-77920e16=""
                      className="icon hover:text-red-500 text-[#fff] aos-init aos-animate"
                      data-aos="zoom-in"
                    ...
                    >
                      ...
                      >
                        ...
                        <defs>
                          <clipPath id="clip0">
                            <rect width="120.9" height="120.5" fill="white" />
                          </clipPath>
                        </defs>
                      </svg>
                    </i>
                  </span>
                  <span data-v-77920e16=""></span>
                  <span data-v-77920e16=""></span>
                </div>
                <div data-v-77920e16="" className="mt-[-81px]">
                  <div
                    data-v-06100610=""
                  ...
                  >
                    <div
                      data-v-06100610=""
                      className="swiper swiper-initialized swiper-horizontal swiper-pointer-events !w-[283px] h-[450px] rounded-12 transition duration-700 ease-in-out z-10 swiper-backface-hidden"
                    >
                      <div
                  ...
                  <div data-v-77920e16="" className="pt-8 line" />
                  <span
                    data-v-77920e16=""
                    className="flex items-center gap-[11px] pt-5 leading-[19px] uppercase font-bold"
                  >
                    <h3
                      data-v-77920e16=""
                      className="font-bold text-white leading-[58px] text-5xl"
                    >
                      10
                    </h3>
                    <h3
                      data-v-77920e16=""
                      className="text-base text-[#00A795] leading-[19px] w-[170px]"
                    >
                      Annual qualification team
                    </h3>
                  </span>
                </div>
                <div data-v-77920e16="" className="about-card2-wrapper">
                  <div
                    data-v-06100610=""
                    className="transition duration-700 ease-in-out AboutCard aos-init aos-animate"
                    data-aos="fade-up"
